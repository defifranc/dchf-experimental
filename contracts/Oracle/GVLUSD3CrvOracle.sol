...
contract GVLUSD3CrvOracle is IOracle {
    IGrizzlyVault public constant GVLUSD3Crv = IGrizzlyVault(0x6B5020a88669B0320fAB5f2771bc35401b0dA6CC);
    ...
    constructor() {
        DECIMAL_ADJUSTMENT = int(10**(LUSD3Crv.decimals() + GVLUSD3Crv.decimals() + LUSD.decimals() - 18)); // 10 ** 18
    }
    ...
    function _getLatestLPTokenPrice() internal view returns (int256 LPPrice) {
        ...
        int256 price = int(GVLUSD3Crv.pricePerShare() * LUSD3Crv.get_virtual_price()) * minStablePrice;
