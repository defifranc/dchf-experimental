...
contract PriceFeedTester is Ownable, CheckContract, BaseMath, Initializable, IPriceFeed {
    ...
    uint256 public mockPrice = 200 ether;
    ...
    function setPrice(uint256 _mockPrice) external onlyOwner {
